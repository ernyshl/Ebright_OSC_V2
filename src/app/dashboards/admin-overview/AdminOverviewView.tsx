...
export function AdminOverviewView({ stats, users }: Props) {
  return (
    <div className="min-h-full bg-slate-50">
      <div className="max-w-7xl mx-auto px-6 pt-4 pb-10">
        ...
        {/* Branch Overview section removed in Phase D (spec: admin page no
            longer shows branch grid — branches owned by separate part of portal) */}
